   ...
   <Table striped>
    ...
    <tbody>
     ...
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-login-id">002345672S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-10-06</td>
      <td className="wd-total-activity">12:51:01</td></tr>
     ...
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-total-activity">4:13:42</td></tr>

     <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          <span className="wd-first-name">Natasha</span>{" "}
          <span className="wd-last-name">Romanoff</span></td>
      <td className="wd-login-id">004567894S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">TA</td>
      <td className="wd-last-activity">2020-09-30</td>
      <td className="wd-total-activity">7:13:35</td></tr>
    </tbody>
   </Table>
  </div> );}