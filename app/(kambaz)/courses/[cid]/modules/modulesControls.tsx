...
export default function ModulesControls() {
 return (
   <div id="wd-modules-controls" className="text-nowrap">
      ...
      <Button size="lg" variant="secondary" className="me-2 float-end" id="wd-view-progress">
        View Progress
      </Button>
      <Button size="lg" variant="secondary" className="me-2 float-end" id="wd-collapse-all">
        Collapse All
      </Button>
   </div>
);}
